...
public class Usuario {
    ...
    public String getPreferenciasEstudio() { return preferenciasEstudio; }
    public void setPreferenciasEstudio(String preferenciasEstudio) { this.preferenciasEstudio = preferenciasEstudio; }
